...
abstract class MovableFragment extends Fragment implements ScaleGestureDetector.OnScaleGestureListener{
    ...
    private MovableFragment.Mode mode            = MovableFragment.Mode.NONE;
    ...
    protected View.OnTouchListener onTouchListener(ViewGroup container, View view) {
